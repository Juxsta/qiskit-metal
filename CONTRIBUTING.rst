...
Welcome to ``qiskit-metal`` contributor's guide.
...
If you experience bugs or general issues with ``qiskit-metal``, please have a look
...
You can help improve ``qiskit-metal`` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

``qiskit-metal`` documentation uses Sphinx_ as its main documentation compiler.
...
.. todo:: If your project is hosted on GitHub, you can also mention the following tip:
   ...
   .. tip::
      ...
      propose changes in ``qiskit-metal``'s files. While this mechanism can
...
#. Clone this copy to your local disk::
    ...
    git clone git@github.com:YourLogin/qiskit-metal.git
    cd qiskit-metal
...
#. Install |pre-commit|_::
   ...
   ``qiskit-metal`` comes with a lot of hooks configured to automatically help the
...
.. _repository: https://github.com/<USERNAME>/qiskit-metal
.. _issue tracker: https://github.com/<USERNAME>/qiskit-metal/issues
.. <-- end -->
